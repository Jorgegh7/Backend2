...
public class UsuarioTest {
    ...
    public void testUsuarioCamposNulos() {
        /*
        Sin Bean Validation (@NotBlank), Java no protege estos campos.
        La restricción nullable = false solo existe en la BD.
        Este test documenta que un Usuario puede construirse con nulls
        y que la validación debe ocurrir en la capa de servicio o con @Valid.
         */
